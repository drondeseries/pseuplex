...
You may also want to disable *Enable Relay*, *Enable local network discovery (GDM)*, and *Enable server support for IPv6*, to prevent the proxy from being circumvented.
